                      ...
                      <td width="750" align="center" valign="top">
	                      <div class="div_workarea_low"> 
		                        ...
		                        <table width="100%" border="0" cellpadding="1" cellspacing="1"> 
							              <form action="empUpdate" method="get" name="updateForm">
												    	<tr>
			                        ...
			                        <tr>  
				                      	<td colspan="4">
				              						<table border="0" width="300" cellspacing="1" cellpadding="1">
															...
															<tr><td colspan="4"><input type="button" value="　変　更　" name="update" class="string" onclick="openPopUpWindowSmall('qualifyUpdate.htm');"></td></tr>
			                        <tr> 
				                      	<td colspan="4">
				              						<table border="0" width="300" cellspacing="1" cellpadding="1">
																		<tr class="trHeader">
